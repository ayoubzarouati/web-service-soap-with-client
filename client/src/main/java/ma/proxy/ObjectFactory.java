...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDh_QNAME = new QName("http://ws.ma/", "conversionEuroToDh");
    private static final QName _ConversionEuroToDhResponse_QNAME = new QName("http://ws.ma/", "conversionEuroToDhResponse");
    private static final QName _GetCompteByCode_QNAME = new QName("http://ws.ma/", "getCompteByCode");
    private static final QName _GetCompteByCodeResponse_QNAME = new QName("http://ws.ma/", "getCompteByCodeResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.ma/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.ma/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.ma/", name = "conversionEuroToDh")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.ma/", name = "conversionEuroToDhResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.ma/", name = "getCompteByCode")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.ma/", name = "getCompteByCodeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.ma/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.ma/", name = "listComptesResponse")
