 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.ma/", wsdlLocation = "http://localhost:2001/?WSDL")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.ma/", "BanqueWS");
    ...
    public BanqueController getBanqueControllerPort() {
        return super.getPort(new QName("http://ws.ma/", "BanqueControllerPort"), BanqueController.class);
    }
    ...
    public BanqueController getBanqueControllerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ma/", "BanqueControllerPort"), BanqueController.class, features);
    }
